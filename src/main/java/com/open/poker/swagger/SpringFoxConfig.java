...
public class SpringFoxConfig {
    ...
    public Docket swaggerApi() {
        return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.basePackage("com.open.poker.controller"))
                .paths(PathSelectors.regex("/.*")).build().apiInfo(apiEndPointsInfo());
    }

    private ApiInfo apiEndPointsInfo() {
        return new ApiInfoBuilder().title("Auth Service REST API")
                .description("Authentication REST End Points")
                .contact(new Contact("Rishabh Daim", "www.javaguides.net", "rishabhdaim1991@gmail.com"))
                .license("Apache 2.0")
